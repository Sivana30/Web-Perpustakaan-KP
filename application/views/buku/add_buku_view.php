                    ...
                    <div class="row">
                        ...
                        ?>
                            <form method="post" action="<?php echo base_url() ?>buku/submit" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">ISBN <small>(opsional)</small>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                        <a class="btn btn-primary active" href="<?php echo base_url() ?>buku">Kembali</a>
