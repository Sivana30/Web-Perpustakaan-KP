...
$(function() { 
    ...
    $("#periode").change(function(){
        var prd = $(this).val();
        $.ajax({
            url:"<?php echo base_url() ?>peminjaman/periode",
            type: "POST",
            data: {"periode" : prd},
            cache: false,
            success: function(huh){
                ...
                <div class="x_content">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>peminjaman/submit" role="form" enctype="multipart/form-data">
                        <div class="box-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="periode" name="periode" class="form-control">
                                                    <option value="">Periode Waktu Peminjaman</option>
                                                    <option value="+1 day">1 Hari</option>
                                                    <option value="+3 day">3 Hari</option>
                                                    <option value="+14 day">14 Hari</option>
                                                    <option value="+6 month">1 Semester</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="tbDateEnd" id="tbDateEnd" class="form-control"  readonly="readonly">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="submit" name="submit" class="btn btn-primary active" value="Simpan">
                                </div>
                            </div>
                        </div>
                    </form>
