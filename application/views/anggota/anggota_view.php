<div class="">
    ...
    <?php if($this->session->userdata('role')=='superadmin'){echo '<a href="'.base_url().'anggota/add" class="btn btn-primary active pull-right"><i class="fa fa-plus"></i> Tambah Anggota</a>';} ?>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $listAnggota->ANGKATAN ?></td>
